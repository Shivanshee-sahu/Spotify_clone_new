...
<p className='bg-white text-black cursor-pointer font-medium text-[15px] px-4 py-1 rounded-2xl hidden md:block'>Explore Premium</p>
<p className='bg-black px-3 py-1 rounded-2xl text-[15px] font-medium cursor-pointer'>Install App</p>
        <p className='rounded-full w-7 h-7 bg-pink-500 flex items-center justify-center text-black font-medium'>S</p></div>
    </div>
